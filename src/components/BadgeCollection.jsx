                    ...
                    earnedBadges.map((item) => (
                        ...
                        >
                            <p className="text-3xl">
                                {item.badges?.badge_key === 'first_task' && '🎯'}
                                {item.badges?.badge_key === 'seven_day_streak' && '🔥'}
                                {item.badges?.badge_key === 'hundred_tasks' && '🏆'}
                                {item.badges?.badge_key === 'fifty_pomodoros' && '🍅'}
                                {item.badges?.badge_key === 'brain_dump_master' && '🧠'}
                                {item.badges?.badge_key === 'planned_30_days' && '📅'}
                                {![
                                    'first_task',
                                    'seven_day_streak',
                                    'hundred_tasks',
                                    ...
                                    'brain_dump_master',
                                    'planned_30_days',
                                ].includes(item.badges?.badge_key) && '🏆'}
                            </p>
